...
RI_PERCENTILE = 0.995   # show up to this Ri percentile; annotate remaining outliers
RI_MAX = 5.0            # optional hard upper bound; set to a float to override percentile
...
# X limits with small padding around the clipped max
